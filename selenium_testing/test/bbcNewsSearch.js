...
beforeEach(async function() {
        ...
        it('should search news by "Minsk" value', async function() {
            ...
            let euronewsTitle = driver.findElement(By.className('o-site-header__logo'));
            await driver.executeScript("arguments[0].style.backgroundColor = '" + "red" + "'", euronewsTitle);
            let searchField = driver.findElement(By.xpath('//*[@id="search-autocomplete"]/div[1]/input'));
            await driver.actions().click(searchField).keyDown(Key.SHIFT).sendKeys("Minsk").keyUp(Key.SHIFT).perform();
        ...
        it('should find the particular news on page', async function() {
            ...
            driver.sleep(5000);
            await driver.actions().click(await driver.findElement(By.linkText('Belarus state airline Belavia and Turkey move to stop migrant flights'))).perform();
            driver.sleep(5000);
